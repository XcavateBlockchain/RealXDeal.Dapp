...
export default function SiteFooter() {
  return (
    <footer className="flex w-full flex-col gap-10 bg-primary">
      ...
      <div className="container mx-auto flex w-full max-w-screen-2xl items-center  flex-col sm:flex-row sm:justify-between px-[20px] sm:px-[100px] pb-4">
        <p className="text-[0.6875rem]/[1.7rem] text-primary-foreground text-center sm:text-left">
