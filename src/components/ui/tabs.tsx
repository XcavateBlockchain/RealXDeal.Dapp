...
const tabTriggerVariants = cva('disabled:pointer-events-none disabled:opacity-50', {
  variants: {
    variant: {
      ...
      pill: 'p-2 text-[0.875rem]/[1.5rem] border rounded-lg border-[#CCCCCC80] font-sans text-[#CCCCCC80] hover:border-primary-300 hover:text-primary-300 font-light flex items-center data-[state=active]:border-primary-300 data-[state=active]:text-primary-300'
    }
  },
  defaultVariants: {
    variant: 'default'
