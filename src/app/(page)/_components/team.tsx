...
export function TeamSection() {
  return (
    <section
      id="team"
      className="container mx-auto flex w-full max-w-screen-2xl flex-col items-center justify-center gap-10 px-4 pb-[150px] pt-[10px] sm:px-[100px] sm:pt-[100px] lg:gap-[100px]"
    >
      ...
      <div className="flex gap-[40px] sm:gap-[130px]">
...
const TeamCard = ({ name, title, img }: CardProps) => {
  return (
    <div className="flex flex-col justify-center gap-0 sm:gap-4">
      <div className="flex items-center justify-center">
        <Image src={img} alt="team" width={100} height={100} priority />
      </div>
      <div className="flex flex-col items-center gap-2 text-[0.5rem]/[1rem] sm:text-[1rem]/[1.5rem]">
